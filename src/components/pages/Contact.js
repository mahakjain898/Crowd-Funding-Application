          ...
          <div className="container">
            <div className="content-section-heading">
              ...
              <h1 className="mb-5" style={{ color: "white" }}>
                Creator and Founder of DONATION NOW ...
              </h1>
            </div>
            <div className="row">
              ...
              <div className="col-lg-2 col-md-6 mb-5 mb-md-0">
                <span className="service-icon rounded-circle mx-auto mb-3">
                  <a
                    href="https://ohhhhhwhen.github.io/React-Portfolio"
                    target="blank_"
                  >
                    <img
                      src={Owen}
              ...
              <div className="col-lg-2 col-md-6 mb-5 mb-md-0">
                <span className="service-icon rounded-circle mx-auto mb-3">
                  <a
                    href="https://ben-react-portfolio-v2.herokuapp.com/"
                    target="blank_"
                  >
                    <img
                      src={Ben}
                ...
                <p className="text-faded mb-0" style={{ color: "white" }}>
                  Software Developer/ Foreign Language Instructor
                </p>
                <p className="text-faded mb-0" style={{ color: "white" }}>
                  University of Washington
                </p>
              ...
              <div className="col-lg-2 col-md-6 mb-5 mb-md-0">
                <span className="service-icon rounded-circle mx-auto mb-3">
                  <a
                    href="http://serene-headland-14339.herokuapp.com/"
                    target="blank_"
                  >
                    <img
                      src={Ari}
              ...
              <div className="col-lg-2 col-md-6">
                <span className="service-icon rounded-circle mx-auto mb-3">
                  <a href="https://github.com/jaredKong" target="blank_">
                    <img
                      src={Jared}
                      style={{ width: "150px", height: "150px" }}
                      alt="Jared Kong"
